...
int main() {
	// String de texto de ejemplo para leer
	char text_to_read_from[] = "My beloved C, I love you <3. Is it possible to create a simple code in c to create a hash table of words in a given text file the table must use the word as key and store the amount of repetifions of said word";
	...
	input_char = strtok(text_to_read_from, " ");
